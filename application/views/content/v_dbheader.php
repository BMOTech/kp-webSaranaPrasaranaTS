      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right" style="padding-top: 5px;"> 
            <li><a href="<?php echo site_url('admin\My_info/ndeleng_akun'); ?>" type="button" style="color: #333"><span class="glyphicon glyphicon-user" style="color: #555"></span> My Account</a></li> 
            <li><a href="<?php echo site_url("admin/admin/logout");?>" style="color: #333"><span class="glyphicon glyphicon-log-out" style="color: #555"></span> Logout</a></li> 
          </ul>
        </div>
      </div>
    </nav>
