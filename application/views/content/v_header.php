<nav class="navbar" style="height: 65px; width: 100%; z-index: 3;">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav" style="padding-top: 5px; padding-left: 10px;">
            <li><a href="<?php echo site_url('utama'); ?>" style="color: #000" class="umah">Home</a></li>
            <li><a href="#about" style="color: #000" class="tentang">About</a></li>
            <li><a href="#contact" style="color: #000" class="contacte">Contact</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right" style="padding-top: 5px;"> 
            <li><a href="#" type="button" data-toggle="modal" data-target="#myModal" style="color: #000" class="logine"><span class="glyphicon glyphicon-log-in" style="color: #000"></span> Sign In</a></li> 
            <li><a href="<?php echo site_url("signUp\daftar");?>" style="color: #000" class="daftare"><span class="glyphicon glyphicon-user" style="color: #000"></span> Sign Up</a></li> 
          </ul>
        </div>
      </div>
    </nav>
