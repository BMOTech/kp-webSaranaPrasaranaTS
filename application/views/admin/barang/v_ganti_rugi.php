	...
	<div class="container">
        <div>
            ...
            <div class="col-md-4">
                ...
                <br>
                    <form action="<?php echo base_url('admin\Barang\barang/input_ganti_rugi') ?>" id="pnjman" method="post">
                    ...
                    <p><i>*Centang Gunakan penanggung jawab sebagai admin, jika yang akan bertanggung jawab adalah admin.</i></p><br>
                    <div class="">
...
$('#submitBtn').click(function() {
 ...
 $(document).ready(function(){
    ...
    $("#choice").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("admin/admin/listJml"); ?>",
        data: {id_barang_keluar : $("#id_barang_keluar").val(), id_barang : $("#id_barang").val(), choice : $("#choice").val()},
        dataType: "json",
    ...
    $("#id_barang").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("admin/admin/listTotHarga"); ?>",
