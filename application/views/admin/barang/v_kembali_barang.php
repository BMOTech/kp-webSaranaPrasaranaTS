...
<body>
	<div id="header">
		<div class="navigasi">
			<ul class="nav">
				<li><a href="<?php echo site_url('admin\Barang\barang/nginput_barang_pengembalian'); ?>">Pengembalian barang</a></li>
				<li><a href="<?php echo site_url('admin\Barang\barang/nginput_barang_pengembalianRusak'); ?>">Pengembalian barang rusak</a></li>
				<li><a href="<?php echo site_url('admin\Barang\barang/nginput_barang_pengembalianHilang'); ?>">Pengembalian barang Hilang</a></li>
			</ul>
		</div>
	</div>
</body>	
