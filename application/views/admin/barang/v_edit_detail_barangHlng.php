...
<body>
    <div class="container"  style="margin-top:100px;">
        <div class="row">
            ...
            <div class="col-md-4">
                <h2><center>Edit detail barang Hilang</center></h2>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <?php foreach($detail_barang as $detil){ ?>
                        <?php echo form_open("admin\Barang\barang/update_detail_barangHlng"); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id_barang" id="id_barang" class="form-control" value="<?php echo $detil->id_peminjaman ?>">
                        </div>
                        <div class="form-group">
