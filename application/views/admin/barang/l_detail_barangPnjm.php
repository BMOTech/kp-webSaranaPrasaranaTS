			...
			<tbody>
				...
				{?>
					<tr>
						...
						<td>
							<?php echo anchor('admin\Barang\barang/ngedit_detail_barangPnjm/'.$detil->no_inv, 'Edit'); ?>
							<span>|</span>
							<?php echo anchor('admin\Barang\barang/ngapus_detail_barangPnjm/'.$detil->no_inv, 'Hapus'); ?>
						</td>
					</tr>
				<?php } ?>
			</tbody>
