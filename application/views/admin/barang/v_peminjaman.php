        ...
        <div>
            ...
            <div class="col-md-4">
                <h2><center>Peminjaman</center></h2>
                    ...
                    <form action="<?php echo base_url('admin\Barang\barang/input_barang_pinjaman') ?>" id="pnjman" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="date" value="tgl_peminjaman" name="tgl_peminjaman" id="tgl_peminjaman" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="">Tanggal Kembali</label>
                        <div class="">
                            <input type="date" value="tgl_kembali" name="tgl_kembali" id="tgl_kembali" class="form-control" onchange="validasitgl()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            ...
                            <p><i>*Keterangan meminjam barang tersebut</i></p>
                        </div>
...
function njajal() 
{
    ...
    if (keterangan_lengthe < 5 && error_inv == true && idbrangklr < 7 && idpnjm < 7 && tglpnjm == "" && tglkmbli == "" && error_tgl == true) 
    {
        $('.pnjmBtn').attr('disabled',true);
    }
    else if (keterangan_lengthe >= 5 && error_inv == false && idbrangklr >= 7 && idpnjm >= 7 && tglpnjm != "" && tglkmbli != "" && error_tgl == false)
    {
...
$('#submitBtn').click(function() {
     $('#peminjam').text("<?php echo $this->session->userdata('fullname'); ?>");
 ...
 $(document).ready(function(){
    ...
    $("#id_ruang").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("admin/admin/listIDBarang"); ?>",
    ...
    $("#id_barang").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url("admin/admin/listInv"); ?>",
