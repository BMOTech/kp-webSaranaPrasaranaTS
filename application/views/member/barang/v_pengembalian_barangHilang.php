    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <?php echo form_open("member\Barang\barang/input_barang_pengembalianHilang"); ?>
...
<script type="text/javascript">
    ...
    function njajal()
    {
        ...
        if (invene < 6 && idbrangklr < 7 && idpnjm < 7 && tglkmbli == "" && tglhlng == "" && satuan < 4 && solusi < 5 && alasan < 5) 
        {
            $('.kmbliHlngBtn').attr('disabled',true);
        }
        else if (invene >= 6 && idbrangklr >= 7 && idpnjm >= 7 && tglkmbli != "" && tglhlng != "" && satuan >= 4 && solusi >= 5 && alasan >= 5)
        {
