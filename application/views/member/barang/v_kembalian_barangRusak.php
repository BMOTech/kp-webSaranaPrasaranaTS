    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form action="<?php echo base_url('member\Barang\barang/pengembalian_barang_rusak') ?>" id="kmblian" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" name="jumlah_rusak" id="jumlah_rusak" class="form-control">
                </div>
                <div class="form-group">
