            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <?php echo form_open("member\My_info/update_akun"); ?>
	                    <div class="form-group">
                            <label>Username</label>
                            <input type="text" name="username" id="username" class="form-control" value="<?php $this->modelku->select_username(); ?>">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" name="email" id="email" class="form-control" value="<?php $this->modelku->select_email(); ?>">
                        </div>
                        <div class="form-group">
                            <label>Fullname</label>
                            <input type="text" name="fullname" id="fullname" class="form-control" value="<?php $this->modelku->select_fullname(); ?>">
                        </div>
